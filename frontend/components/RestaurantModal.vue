    ...
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 z-10">
      <div class="p-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <button @click="close" class="text-surface-400 hover:text-surface-600">
        ...
        <form @submit.prevent="save">
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                type="text"
                required
                class="w-full px-3 py-2 border border-surface-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500"
              />
            </div>
          ...
          <div class="flex justify-end space-x-3 mt-6">
            <button
              type="button"
              @click="close"
              class="px-4 py-2 text-surface-700 bg-surface-100 rounded-md hover:bg-surface-200 transition-colors"
            >
              Cancel
            </button>
            <button
