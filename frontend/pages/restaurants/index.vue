<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <!-- Empty State -->
    <div v-if="!pending && !error && restaurants?.length === 0" class="text-center py-12">
...
// Fetch restaurants
const { data: restaurants, pending, error, refresh } = await useFetch(`${config.public.apiBase}/restaurants`)
